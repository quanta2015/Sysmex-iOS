...
- (void)setupViewWindowWidth:(CGFloat)windowWidth
{
    ...
    self.subTitleHeight = 40.0f;
    self.circleIconHeight = 20.0f;
    self.windowWidth = windowWidth;
    self.windowHeight = 120.0f;
    ...
    //[self.view setBackgroundColor:[UIColor colorWithRed:80 green:0 blue:0 alpha:0.5f]];
    ...
    CGFloat x = (DEFAULT_WINDOW_WIDTH - kCircleHeight) / 2;
    _circleView.frame = CGRectMake(x, 30 , kCircleHeight, kCircleHeight);
    ...
    // Colors
    self.backgroundViewColor = [UIColor colorWithRed:255 green:255 blue:255 alpha:0.85f];
